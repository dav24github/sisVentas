...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-m-6 col-xs12">
			<h3>Nueva Venta</h3>
			@if (count($errors)>0)
	...
	function agregar(){
		...
		if(idarticulo!="" && cantidad!="" && cantidad>0 && descuento!="" && precio_venta!=""){
			if(stock>=cantidad){			
				...
				var fila='<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idarticulo[]" value="'+idarticulo+'">'+articulo+'</td><td><input type="number" name="cantidad[]" value="'+cantidad+'"></td><td><input type="number" name="precio_venta[]" value="'+precio_venta+'"></td><td><input type="number" name="descuento[]" value="'+descuento+'"><td>'+subtotal[cont]+'</td></td></tr>';
				cont++;
				limpiar();
				$("#total").html("S/. "+total);
